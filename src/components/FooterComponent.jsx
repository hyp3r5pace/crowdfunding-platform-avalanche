              ...
              <div className="footerContainer">
                <IconContext.Provider value={{ style: {fontSize: '30px', color: "rgb(0, 123, 255)"}}}>
                    <div className="twitter-icon">
                        <a href="https://twitter.com/crypto_gaijin" target="_blank">
                            <FaTwitter />
                        </a>
                    </div>
                ...
                <IconContext.Provider value={{ style: {fontSize: '30px', color: "rgb(0, 0, 0)"}}}>
                    <div className="github-icon">
                        <a href="https://github.com/hyp3r5pace" target="_blank">
                            <FaGithub />
                        </a>
                    </div>
                </IconContext.Provider>
                <IconContext.Provider value={{ style: {fontSize: '30px', color: "rgb(138, 58, 185)"}}}>
                    <div className="insta-icon">
                        <a href="https://www.instagram.com/sayan.kar2000/" target="_blank">
                            <FaInstagram />
                        </a>
                    </div>
                </IconContext.Provider>
