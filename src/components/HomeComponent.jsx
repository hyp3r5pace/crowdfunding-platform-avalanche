          ...
          <div className="suggestions">
            <div className="suggLeftContainer">
                <div className="featuredCard">
                    ...
                    <div className="featuredProjectDescription">A truthful short film, inspired by real events, about motherhood in prison A truthful short film, inspired by real events, about motherhood in prison A truthful short film, inspired by real events, about motherhood in prison A truthful short film, inspired by real events, about motherhood in prison
                    </div>
                ...
                <div className="recommendationList">
                    ...
                    <div className="recommendationCard">
                        ...
                        <div className="rcmdCardDetails">
                            <div className="rcmdCardHeading">Discos : there us sue the tablethere us sue the tablethere us sue the tablethere us sue the table</div>
